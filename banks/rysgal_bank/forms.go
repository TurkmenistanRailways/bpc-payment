...
var (
	confirmOtpUrl    = fmt.Sprintf("%s%s", banks.RysgalBankBaseUrl, banks.RysgalBankOtpUrl)
	finishPaymentUrl = fmt.Sprintf("%s%s", banks.RysgalBankBaseUrl, banks.RysgalFinishURL)
	sendOtpUrl       = fmt.Sprintf("%s%s", banks.RysgalBankBaseUrl, banks.RysgalBankOtpUrl)
)
